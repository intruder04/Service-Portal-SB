...
use Yii;
use app\models\transport\RequestsTransport;
use app\models\transport\RequestsTransportSearch;

//use yii\db\Query;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

class ReqtrController extends AppController
{
    ...
    {
        $searchModel = new RequestsTransportSearch();
...
//        $this->view->params['controlButtonsAccess'] = $this->controlButtonsAccess();
    ...
    public function actionPricesent()
    {
        $searchModel = new RequestsTransportSearch();
        $newOrder = new NewOrder();
...
//        debug('hi');
        $prevNext = new RequestsTransportSearch();
...
//        Логика кнопок действий
        if ($status_change) {
            $buttonLogicObj = new RequestsTransportSearch();
...
//            debug($model);die;
    ...
    {
        if (($model = RequestsTransport::findOne($id)) !== null) {
            return $model;
        } else {
