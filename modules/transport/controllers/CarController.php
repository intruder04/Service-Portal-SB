...
use app\models\transport\TransportCarSearch;
use app\controllers\AppController;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * CarController implements the CRUD actions for TransportCar model.
 */
class CarController extends AppController
{
    ...
    {
        $searchModel = new TransportCarSearch();
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['/transport/car']);
        } else {
    ...
    {
        if (($model = TransportCar::findOne($id)) !== null) {
            return $model;
        } else {
