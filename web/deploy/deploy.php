...
class Deploy {
     ...
     * @var string
     */
    private $_log = '/var/www/www.sfriend.ru/web/deploy/deploy.log';
    ...
    public function execute()
    {
        try
        {
            ...
            $this->log('Reseting... '.implode(' ', $output));

            // Update the local repository
            exec('git pull '.$this->_remote.' '.$this->_branch, $outputpull);
            $this->log('Pulling in changes... '.implode(' ', $outputpull));
