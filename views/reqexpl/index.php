...
echo ExportMenu::widget([
    ...
    'columns' => [
        ...
        [
            'attribute'=>'status',
            'content'=>function($model){
                return (ArrayHelper::getValue((ArrayHelper::map(Statuses::find()->all(), 'id', 'status')),$model->status,'Нет статуса'));
            },
        ],
        'descr',
        'full_descr',
