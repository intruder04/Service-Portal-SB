...
xml_instances = ''
for call in sd_ids:
	queryres = makeQuery("select","SELECT id, sb_id, solution, status, closure_code, date_done, ride_end_time, ride_duration, ride_idle_time, ride_distance, ride_price from requests where sb_id = \'"+call+"\'")
